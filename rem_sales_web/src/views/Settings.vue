...
<style scoped>
.settings-container { padding: 40px; font-family: 'ABeeZee', sans-serif; background-color: #FFFAFA; min-height: 100vh; }
h2 { color: #000; font-family: 'Ysabeau Office', sans-serif; font-size: 2rem; margin-bottom: 30px; }
.danger-zone { border: 2px dashed #d32f2f; padding: 25px; border-radius: 8px; max-width: 600px; background-color: #fff; }
.danger-zone h3 { color: #d32f2f; margin-top: 0; font-size: 1.2rem; }
.danger-zone p { color: #555; font-size: 0.9rem; line-height: 1.5; margin-bottom: 20px; }
